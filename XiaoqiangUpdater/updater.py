...
def updater_config_example(save_path: str = None, print_eg: bool = True) -> dict:
    """
    打印updater_config.json的示例内容。

    :param save_path: 保存示例文件的路径，可选。
    :param print_eg: 是否打印示例内容，可选。
    :return: 示例配置字典。
    """
    example_config = {
        "current_version": "1.0.0",  # 你的程序当前版本
        "latest_version": "1.1.0",  # 你的程序最新版本，使用代码从服务器或使用其他方式获取
        "update_url": "https://fs-im-kefu.7moor-fs1.com/ly/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1716705346432/dist.zip",
        # 你的程序更新包的下载地址，使用代码从服务器或使用其他方式获取
        "main_app": "app.exe",  # 你的程序的主入口文件，确保每个版本的主程序入口文件名都相同，相同，相同，相同！
        "verify_file_md5": "1e42b15eedc1066af972bb14f4329781",  # 你的程序更新包的MD5值，使用代码从服务器或使用其他方式获取
        "logo_path": "",  # updater的logo图标，可以省略
        "open_current_version_on_fail": True,  # 如果更新失败，是否打开当前版本的应用程序
        "install_dir": ""  # 程序更新安装目录。可选，默认值为updater所在目录
    }
